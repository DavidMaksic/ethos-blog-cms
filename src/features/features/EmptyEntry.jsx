...
function EmptyEntry({ currentTag }) {
   ...
   return (
      <>
         <li
            className="relative flex justify-center h-[20rem] w-[16rem] border rounded-3xl group transition px-5 py-5 bg-cover cursor-pointer hover:bg-accent-100/10 dark:hover:bg-primary-200 border-quaternary hover:border-accent-300 dark:hover:border-accent-400/80"
