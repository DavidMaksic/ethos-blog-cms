...
function CategoryChart({ articles, numDays }) {
   ...
   return (
      <div className="categories col-start-3 col-span-2 space-y-4 text-base bg-white dark:bg-primary-300/10 rounded-xl py-8 px-10 box-shadow transition-200 z-10">
