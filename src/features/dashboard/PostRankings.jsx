...
function PostRankings({ numDays }) {
   ...
   return (
      <div className="col-span-2 row-span-2 space-y-6 bg-white dark:bg-primary-300/10 rounded-2xl py-8 px-10 box-shadow transition-200 min-h-196">
         ...
         <div className="flex items-center gap-6 px-0 text-xs font-medium text-primary-300 uppercase tracking-wider mb-4">
            ...
            <div className="w-14 flex justify-end shrink-0">Change</div>
         </div>
