   ...
   return (
      <div className="flex items-center">
         ...
         <input
            ...
            className="h-11 py-4 px-1 w-[22rem] xl:w-[20rem] bg-white dark:bg-primary-200 border border-quaternary rounded-full text-xl font-medium font-article outline-none transition-bg_border rounded-l-none border-l-transparent"
         />
      </div>
   );
}
