...
function ArticleNotFound({ to, prompt, children }) {
   return (
      <div className="max-h-screen flex justify-center">
         <div
            className={`self-center box-shadow bg-secondary dark:bg-primary-200 px-20 py-12 flex flex-col gap-10 rounded-3xl border border-quaternary translate-y-50 ${
               !to && 'gap-0!'
            }`}
         >
